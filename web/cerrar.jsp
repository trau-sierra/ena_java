<%-- 
    Document   : cerrar
    Created on : 20-07-2020, 20:46:21
    Author     : Usuario
--%>
            ...
            <div class="row">
                <div class="col s6 offset-s3" >
                    <div class="card-panel z-depth-5">
                        <center>     <h5>Cerrar Requerimiento</h5> </center> 
                        <br>

                        <div  class="input-field">
                <form action="cerrar_req" method="post">
                        <div  class="input-field">
                        ...
                        <table class="striped">
                            ...
                            <tr>
                                ...
                                <td><a href="cerrar_req" class="waves-effect waves-light red btn"><i class="material-icons center-align">highlight_off</i></a></td> 
